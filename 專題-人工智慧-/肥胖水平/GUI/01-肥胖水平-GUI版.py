...
def event1():
    ...
    dfX = pd.DataFrame([[float(v1),float(v2),float(v3),float(v4),
...
combobox1 = ttk.Combobox(win,values=["Female",
                                     "Male"])
combobox1.grid(column=0, row=1)
combobox1.current(0)
combobox1.place(x=10,y=80+t+25)
...
combobox3 = ttk.Combobox(win,values=["Yes",
                                     "No"])
combobox3.grid(column=0, row=1)
combobox3.current(0)
combobox3.place(x=10,y=80+t+25)
#輸入框4>下拉式選單
t=50
label4=tk.Label(win,text="經常吃高熱量的食物嗎")
label4.place(x=10,y=80+t)
combobox4 = ttk.Combobox(win,values=["Yes",
                                     "No"])
combobox4.grid(column=0, row=1)
combobox4.current(0)
combobox4.place(x=10,y=80+t+25)
#輸入框5
t=90
...
combobox8 = ttk.Combobox(win,values=["Yes",
                                     "No"])
combobox8.grid(column=0, row=1)
combobox8.current(0)
combobox8.place(x=200,y=80+t+25)
#輸入框9
t=50
