...
資料來源:
指數股票型ETF基金發行概況表
https://data.gov.tw/dataset/129347

主要欄位說明:
年月、國內股票型ETF基金數、國內股票型ETF淨資產價值_十億元、國外股票型ETF基金數、國外股票型ETF淨資產價值_十億元、
債券型ETF基金數、債券型ETF淨資產價值_十億元、槓桿型_反向型證券ETF基金數、槓桿型_反向型證券ETF淨資產價值_十億元、
境外ETF基金數、境外ETF淨資產價值_十億元、期貨ETF基金數、期貨ETF淨資產價值_十億元、
槓桿型_反向型期貨ETF基金數、槓桿型_反向型期貨ETF淨資產價值_十億元、
其他類型ETF基金數、其他類型ETF淨資產價值_十億元、合計基金數、合計淨資產價值_十億元、
公告日期
"""
...
df = pd.read_csv('每月指數股票型ETF基金發行概況表.csv')
