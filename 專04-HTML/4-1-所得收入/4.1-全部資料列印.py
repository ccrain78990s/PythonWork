...
try:
    ...
    if reponse.code == 200:
        ...
        # 印出所有資料
        for x in range(0, len(t0)):
            print("年份:", t1[x].text,"</br>")
            print("台灣地區平均每人所得收入總計:", t2[x].text,"</br>")
            print("   ","</br>")
            print("民意代表及主管及經理人員:", t3[x].text,"</br>")
            print("專業人員:", t4[x].text,"</br>")
            print("技術員及助理專業人員:", t5[x].text,"</br>")
            print("事務支援人員:", t6[x].text,"</br>")
            print("服務及銷售工作人員:", t7[x].text,"</br>")
            print("農林漁牧業生產人員:", t8[x].text,"</br>")
            print("技藝有關工作人員:", t9[x].text,"</br>")
            print("機械設備操作及組裝人員:", t10[x].text,"</br>")
            print("基層技術工及勞力工:", t11[x].text,"</br>")
            print("其他:", t12[x].text,"</br>")
            print("<hr/>","</br>")
            print("   ","</br>")
        ...
        rate=""
        if rate == "民意代表及主管及經理人員":
            for year in d2:
                rate_=d2[year]
                print('%s 年成長率= %s' % (year,rate_))
        """
        print("民意代表及主管及經理人員:", list[0], "</br>")
        print("專業人員:", list[1], "</br>")
        print("技術員及助理專業人員:", list[2], "</br>")
